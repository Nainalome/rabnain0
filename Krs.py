...
def rcrack(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5744.226", "Google Chrome";v="114.0.5744.226"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"itel L5002"',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 9; BAH3-L09) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5744.226 Mobile Safari/537.36',
    'viewport-width': '980',}
